      ...
      <footer style={styles.footer}>
        <div style={styles.footerTop}>
          ...
          <div style={styles.footerCol}>
            ...
            <a href="http://localhost:5174" style={styles.footerLink}>👤 Employee Portal</a>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  hint: { background: '#e8f5e9', border: '1px solid #a5d6a7', borderRadius: '6px', padding: '10px 14px', marginBottom: '1.2rem', fontSize: '0.85rem', color: '#1b5e20' },
