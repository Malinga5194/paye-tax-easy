...
export default function LoginPage() {
  ...
  return (
    <div style={styles.page}>
      <Header portalName="Employer Portal" portalIcon="🏢" color={COLOR} />
...
const styles: Record<string, React.CSSProperties> = {
  ...
  hint: { background: '#e8f0fb', border: '1px solid #bee3f8', borderRadius: '6px', padding: '10px 14px', marginBottom: '1.2rem', fontSize: '0.85rem', color: '#2c5282' },
